...
if __name__ == "__main__":
    ...
    for bus_file in selected_bus_files:
        ...
        timeframe = [
            ...
            (f"{year}-02-01 00:00:00", f"{year}-02-28 23:00:00"),
            (f"{year}-03-01 00:00:00", f"{year}-03-31 23:00:00"),
            (f"{year}-04-01 00:00:00", f"{year}-04-30 23:00:00"),
            (f"{year}-05-01 00:00:00", f"{year}-05-31 23:00:00"),
            (f"{year}-06-01 00:00:00", f"{year}-06-30 23:00:00"),
            (f"{year}-07-01 00:00:00", f"{year}-07-31 23:00:00"),
            (f"{year}-08-01 00:00:00", f"{year}-08-31 23:00:00"),
            (f"{year}-09-01 00:00:00", f"{year}-09-30 23:00:00"),
            (f"{year}-10-01 00:00:00", f"{year}-10-31 23:00:00"),
            (f"{year}-11-01 00:00:00", f"{year}-11-30 23:00:00"),
            (f"{year}-12-01 00:00:00", f"{year}-12-31 23:00:00"),
        ]
